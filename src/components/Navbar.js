...
const Navbar = () => {
  return (
    <nav className="navbar navbar-expand-lg navbar-light" role={"navigation"} id="home">
        <a className="navbar-brand" href="#home"><img className="logo" src={Logo} alt="My logo."/></a>
